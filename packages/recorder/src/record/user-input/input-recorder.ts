...
export class EventCallbackCreator {
  ...
  constructor(
    @inject(RecordingDomManager) private domWalker: Pick<RecordingDomManager, "fetchManagedNode" | "isHidden" | "isManaged">,
    @inject(TimeManager) private timeManager: Pick<TimeManager, "currentTime">
  ) { }
...
export class CompleteInputRecorder {
  ...
  constructor(
    ...
    @inject(GlobalEventService) private globalEventService: Pick<GlobalEventService, "addEventListener" | "removeEventListener">,
